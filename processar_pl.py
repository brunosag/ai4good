    ...
    schema_json_fixo = {
        ...
        "properties": {
            ...
            "verbo_acao": {
                ...
                "enum": [
                    "Criação", "Alteração", "Revogação", "Proibição", 
                    "Nomeação", "Autorização", "Declaração", "Instituição", "Outro"
                ]
            },
            "impacto_orcamentario": {
                ...
                "enum": [
                    "Cria Despesa", "Aumenta Arrecadação", "Não Gera Despesa", 
                    "Impacto Neutro", "Não Especificado"
                ]
            },
            "areas_tematicas": {
                "type": "array",
                ...
                "items": {
                    "type": "string",
                    "enum": [
                        "Saúde", "Educação", "Transporte", "Meio Ambiente", "Urbanismo",
                        "Assistência Social", "Direitos Humanos", "Cultura", "Esporte",
                        "Finanças", "Administração", "Segurança", "Tecnologia", "Habitação"
                    ]
                }
            },
            "publico_alvo": {
                ...
                "items": {
                    "type": "string",
                    "enum": [
                        "Crianças e Adolescentes", "Idosos", "Pessoas com Deficiência",
                        "Mulheres", "Jovens", "Consumidores", "Servidores Públicos",
                        "Empresas", "Animais", "População de Baixa Renda", "Cidadão em Geral"
                    ]
                }
            }
        },
        "required": [
            "resumo_abstrativo", "justificativa_resumida", "evidencias", 
            "impacto_orcamentario", "areas_tematicas", "publico_alvo", 
            "verbo_acao", "entidades_envolvidas", "prazo_vigencia"
        ]
    }
